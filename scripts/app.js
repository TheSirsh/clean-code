...
var addButton=document.querySelector(".add-section__add-button");//first button
var incompleteTaskHolder=document.querySelector(".incomplete-section__tasks");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".complete-section__tasks");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    deleteButtonImg.className="task__delete-button__image";
